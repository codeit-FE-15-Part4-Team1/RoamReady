        ...
        <div className='rounded-xl bg-white p-8 shadow-sm'>
          ...
          <Tabs defaultValue='settings'>
            <div className='flex gap-4'>
              <TabsList className='flex w-32 flex-col space-y-1'>
                <TabsTrigger
                  value='settings'
              ...
              <div className='flex-1'>
                <TabsContent value='settings' className='rounded border p-4'>
                  <h3 className='mb-2 font-semibold'>설정</h3>
                  <p>일반 설정 옵션들을 관리할 수 있습니다.</p>
                </TabsContent>
                <TabsContent value='profile' className='rounded border p-4'>
                  <h3 className='mb-2 font-semibold'>프로필</h3>
                  <p>사용자 프로필 정보를 수정할 수 있습니다.</p>
                </TabsContent>
                <TabsContent value='security' className='rounded border p-4'>
