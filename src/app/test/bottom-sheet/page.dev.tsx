...
export default function BottomSheetTestPage() {
  ...
  return (
    <div className='flex h-screen flex-col gap-50 p-30'>
      <div className=''>
        <h1 className='font-size-30 font-bold'>BottomSheet 테스트 페이지</h1>
        <p className='font-size-16 text-gray-500'>
          비제어, 제어, 다중 스텝 바텀시트를 테스트해볼 수 있습니다.
        </p>
      </div>
      <div className='flex flex-col gap-20'>
        <div className='flex flex-col'>
          ...
          <div className='mt-20 flex flex-1 gap-40'>
            ...
            <div className='flex-1 rounded-3xl bg-gray-900 p-20'>
              <pre className='font-size-16 whitespace-pre-wrap text-gray-50'>
                {`<BottomSheet.Root>
  <BottomSheet.Trigger>
    <Button className='font-size-20'>OPEN</Button>
  </BottomSheet.Trigger>
  <BottomSheet.Content>
    <BottomSheet.Header>
      <span>BottomSheet 헤더</span>
    ...
    <BottomSheet.Footer>
      <Button variant='primary' size='large'>
        ...
        <div className='flex flex-col'>
          ...
          <p className='font-size-18 text-gray-800'>
            모바일 환경에서 BottomSheet를 여러 스텝으로 구성해야 하는 경우
            다음과 같이 사용합니다.
            <br />
            1.{' '}
            <code className='rounded-lg bg-gray-100 px-6 py-2 font-semibold text-gray-800'>
