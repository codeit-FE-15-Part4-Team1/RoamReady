...
interface TriggerProps {
  ...
  className?: string;
  onClick?: () => void;
  triggerType?: 'password-toggle' | 'file-upload' | 'base';
}
 ...
 * - `type="base"`: 그 외의 범용적인 트리거 버튼. `children`으로 전달된 내용을 렌더링합니다.
 *
 ...
 * @param {'password-toggle' | 'file-upload' | 'base'} [props.type] - 트리거의 목적을 정의하는 타입. 기본값은 'base'.
 *
