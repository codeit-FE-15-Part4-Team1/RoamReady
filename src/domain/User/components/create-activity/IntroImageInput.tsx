...
export default function IntroImageInput() {
  const { control } = useFormContext(); // RHF control 사용
  const { previewUrl } = useImagePreview('introImage', control); // 'introImage'는 RHF의 필드 이름

  return (
    <div>
      <Input.Root id='intro' name='introImage' type='file' className='my-10'>
