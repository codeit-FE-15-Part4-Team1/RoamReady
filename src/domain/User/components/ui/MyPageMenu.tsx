...
export default function MyPageMenu() {
  ...
  return (
    <div className='border-brand-1 tablet:max-w-178 desktop:max-w-290 rounded-3xl border px-24 py-16 shadow-lg'>
      {/* 유저 프로필 아바타 (수정 가능) */}
      <EditableAvatar
        initialImageUrl=''
      ...
      <ul
        ...
        className='relative flex w-full flex-col gap-4 pb-24'
          ...
          return (
            ...
            >
              ...
              <Link href={item.href} className='relative z-10 block'>
                <div
                  className={cn(
                    'relative flex items-center gap-8 rounded-3xl px-20',
