...
export default function MyPageMenu() {
  ...
  return (
    <div className='tablet:border-brand-1 tablet:border tablet:shadow-lg tablet:px-24 tablet:py-16 tablet:sticky tablet:top-24 tablet:w-178 desktop:w-290 w-full rounded-3xl'>
      {/* 유저 프로필 아바타 (수정 가능) */}
          ...
          return (
            ...
            >
              ...
              <Link href={item.href} className='relative z-10 block'>
                <div
                  className={cn(
                    'tablet:px-20 tablet:rounded-3xl tablet:border-none relative flex items-center justify-between border-b border-b-neutral-100',
